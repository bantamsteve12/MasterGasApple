...
@interface JobsheetPDFViewController ()

@end

@implementation JobsheetPDFViewController

@synthesize webView;
@synthesize currentJobsheet;
@synthesize maintenanceServiceItems;
@synthesize managedObjectContext;
@synthesize managedObject;

@synthesize mode;
@synthesize aJobsheet;
...
-(void)generateCertificate
{
    ...
    NSString *certificateReportLayoutName = @"Jobsheet";
    
    [PDFJobsheetRenderer drawPDF:fileName withJobsheet:aJobsheet withCertificateReportLayoutName:certificateReportLayoutName];
...
-(void)saveToDropbox
{
    ...
    NSString *filename = [NSString stringWithFormat:@"%@.pdf", currentJobsheet.jobsheetNo];
...
-(void)emailToCustomer
{
   ...
   [picker setSubject:@"Jobsheet Attached"];
    
    // Set up recipients
    if ([aJobsheet.customerEmail length] > 0) {
        NSArray *toRecipients = [NSArray arrayWithObject:aJobsheet.customerEmail];
    ...
    [picker addAttachmentData:pdfData mimeType:@"application/pdf" fileName:[NSString stringWithFormat:@"%@.pdf",currentJobsheet.jobsheetNo]];
    
    [picker setMessageBody:@"Please find attached your jobsheet." isHTML:NO];
