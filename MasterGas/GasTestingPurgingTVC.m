...
@interface GasTestingPurgingTVC ()
@property (nonatomic, strong) NSDateFormatter *dateFormatter;
@property (nonatomic, strong) NSManagedObjectContext *managedObjectContext;
@end

@implementation GasTestingPurgingTVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([self.entityName isEqualToString:@"NonDomesticPurgingTesting"]) {
        ...
        NonDomesticPurgingTesting *certificate = [eventsOnThisDay objectAtIndex:indexPath.row];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([segue.identifier isEqualToString:@"ShowCertificateSegue"]) {
        ...
        CertificateHeaderTVC *certificateHeaderTVC = segue.destinationViewController;
        certificateHeaderTVC.certificatePrefix = @"GTP";
