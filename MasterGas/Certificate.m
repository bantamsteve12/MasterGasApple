...
@dynamic cylinderFinalConnection;
@dynamic date;
@dynamic engineerId;
...
@dynamic finalCheckECV;
@dynamic finalCheckEquipotentialBonding;
@dynamic finalCheckGasInstallationPipework;
@dynamic finalCheckGasTightness;
@dynamic finalCheckGasTightnessFinalValue;
@dynamic finalCheckGasTightnessInitialValue;
@dynamic lpgRegulatorLockupPressure;
@dynamic lpgRegulatorOperatingPressure;
@dynamic objectId;
