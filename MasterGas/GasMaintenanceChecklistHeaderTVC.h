//
//  GasMaintenanceChecklistHeaderTVC.h
//  MasterGas
//
...
@interface GasMaintenanceChecklistHeaderTVC : UITableViewController<DatePickerTVCDelegate, MBProgressHUDDelegate> {
	MBProgressHUD *HUD;
}
...
@property (strong, nonatomic) IBOutlet UILabel *applianceCompletionSafetyChecksLabel;
@property (strong, nonatomic) IBOutlet UILabel *findingsLabel;
