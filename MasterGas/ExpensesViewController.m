...
- (void)loadRecordsFromCoreData {
    [self.managedObjectContext performBlockAndWait:^{
        ...
        [request setPredicate:[NSPredicate predicateWithFormat:@"(syncStatus != %d) AND (expenseUniqueReference == %@)", SDObjectDeleted, self.currentExpense.uniqueClaimNo]];
...
{
    aExpense = currentExpense;
    
    expenseItems = [[NSMutableArray alloc] init];
    ...
    NSMutableArray *expenseItemsMutableArray = [NSMutableArray arrayWithArray:expenseItems];
...
-(void)saveToDropbox
{
    ...
    NSString *filename = [NSString stringWithFormat:@"%@.pdf", currentExpense.uniqueClaimNo];
...
-(void)emailToCustomer
{
    ...
    [picker setSubject:@"Expense Record Attached"];
    ...
    [picker addAttachmentData:pdfData mimeType:@"application/pdf" fileName:[NSString stringWithFormat:@"%@.pdf",currentExpense.uniqueClaimNo]];
    
    
    // Fill out the email body text
    NSString *emailBody = @"Please find attached the expense record document.";
