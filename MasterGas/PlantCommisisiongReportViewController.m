//
//  PlantCommisisiongReportViewController.m
//  MasterGas
//
...
@interface PlantCommisisiongReportViewController ()

@end

@implementation PlantCommisisiongReportViewController
...
- (void)loadRecordsFromCoreData {
    ...
    [self.managedObjectContext performBlockAndWait:^{
        ...
        [request setPredicate:[NSPredicate predicateWithFormat:@"(certificateReference == %@)", self.currentCertificate.certificateNumber]];
...
-(void)generateCertificate
{
    ...
    NSString *certificateReportLayoutName = @"PlantCommissioningServiceNonDom";
    
    
    [PlantCommissioningRenderer drawPDF:fileName withCertificate:aCertificate withInspection:applianceInpects withCertificateReportLayoutName:certificateReportLayoutName];
...
-(void)emailToCustomer
{
    if ([MFMailComposeViewController canSendMail]) {
        ...
        [picker setSubject:@"Plant Commissioning / Service Record Attached"];
        ...
        {
            [picker setMessageBody:@"Please find attached your Plant Commissioning / Service Record." isHTML:NO];
        }
