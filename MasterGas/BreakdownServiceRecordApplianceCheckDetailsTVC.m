//
//  BreakdownServiceRecordApplianceCheckDetailsTVC.m
//  MasterGas
//
...
@interface BreakdownServiceRecordApplianceCheckDetailsTVC ()
@property CGPoint originalCenter;
@end

@implementation BreakdownServiceRecordApplianceCheckDetailsTVC
...
@synthesize applianceBurnerMakeField;
@synthesize applianceBurnerModelField;
...
- (void)viewDidLoad
{
    ...
    self.applianceBurnerMakeField.text = [self.managedObject valueForKey:@"applianceBurnerMake"];
    self.applianceBurnerModelField.text = [self.managedObject valueForKey:@"applianceBurnerModel"];
    ...
    self.gasTightnessTestCarriedOutSegment.selectedSegmentIndex = [LACHelperMethods YesNoNASegementControlSelectedIndexForValue:[self.managedObject valueForKey:@"gasTightnessCarriedOut"]];
...
-(void)SaveAll
{
    ...
    [self.managedObject setValue:[NSString checkForNilString:self.applianceBurnerMakeField.text] forKey:@"applianceBurnerMake"];
    [self.managedObject setValue:[NSString checkForNilString:self.applianceBurnerModelField.text] forKey:@"applianceBurnerModel"];
