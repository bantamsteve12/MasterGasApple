...
-(void)generateCertificate
{
   ...
   // applianceInspections = [[NSMutableArray alloc] init];
    ...
    NSString *certificateReportLayoutName = @"";
    
    if ([aCertificate.certificateType isEqualToString:@"Landlord Gas Safety Record"]) {
        certificateReportLayoutName = @"LandlordCert";
    }
    else if([aCertificate.certificateType isEqualToString:@"LPG Gas Safety Record"])
    {
        certificateReportLayoutName = @"LandlordCertLPG";
    }
    
    
    [PDFRenderer drawPDF:fileName withCertificate:aCertificate withInspection:applianceInpects withCertificateReportLayoutName:certificateReportLayoutName];
