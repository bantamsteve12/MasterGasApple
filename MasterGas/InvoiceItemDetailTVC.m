...
@interface InvoiceItemDetailTVC ()
...
@implementation InvoiceItemDetailTVC
...
- (void)viewDidLoad
{
    ...
    if (self.selectedInvoiceItem == nil) {
        NSLog(@"insert new detail");
        
        self.managedObject = [NSEntityDescription insertNewObjectForEntityForName:@"InvoiceItem" inManagedObjectContext:self.managedObjectContext];
