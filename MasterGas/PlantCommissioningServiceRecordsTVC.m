//
//  PlantCommissioningServiceRecordsTVC.m
//  MasterGas
//
...
#import "PlantCommissioningServiceRecordsTVC.h"
...
@interface PlantCommissioningServiceRecordsTVC ()
@property (nonatomic, strong) NSDateFormatter *dateFormatter;
@property (nonatomic, strong) NSManagedObjectContext *managedObjectContext;
@end

@implementation PlantCommissioningServiceRecordsTVC
...
-(void)setupTitleDescriptorsAndOrdering
{
    ...
    for (PlantCommissioningService *cert in self.certificates)
    {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([self.entityName isEqualToString:@"PlantCommissioningService"]) {
        ...
        PlantCommissioningService *certificate = [eventsOnThisDay objectAtIndex:indexPath.row];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([segue.identifier isEqualToString:@"ShowCertificateSegue"]) {
        PlantCommissioningServiceHeaderTVC *certificateHeaderTVC = segue.destinationViewController;
        ...
        PlantCommissioningServiceHeaderTVC *certificateHeaderTVC = segue.destinationViewController;
        certificateHeaderTVC.certificatePrefix = @"PCS";
