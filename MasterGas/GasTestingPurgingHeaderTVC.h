...
@interface GasTestingPurgingHeaderTVC : UITableViewController <DatePickerTVCDelegate, MBProgressHUDDelegate> {
	MBProgressHUD *HUD;
}
...
@property (strong, nonatomic) IBOutlet UISegmentedControl *installationIsSafeOrUnsafeSegementControl;
