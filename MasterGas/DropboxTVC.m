...
- (void)alertSuccess:(BOOL)success {
    ...
    if (success) {
        ...
        message = [NSString stringWithFormat:@"A backup has been created. It will appear in the Apps/Master Gas directory of your Dropbox. Consider removing old backups when you no longer require them"];
    } else {
