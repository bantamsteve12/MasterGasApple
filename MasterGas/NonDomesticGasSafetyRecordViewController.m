//
//  NonDomesticGasSafetyRecordViewController.m
//  MasterGas
//
...
@implementation NonDomesticGasSafetyRecordViewController
...
-(void)generateCertificate
{
    ...
    NSString *certificateReportLayoutName = @"SafetyRecordNonDomestic";
    

    [NonDomesticGSRRenderer drawPDF:fileName withCertificate:aCertificate withInspection:applianceInpects withCertificateReportLayoutName:certificateReportLayoutName];
