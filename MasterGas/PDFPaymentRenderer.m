...
@implementation PDFPaymentRenderer
...
+(void)drawLabels:(NSString*)reportLayoutName
{
    ...
    for (UIView* view in [mainView subviews]) {
        if([view isKindOfClass:[UILabel class]])
        {
            ...
            {
                case 10:{
                    NSString *str = currentInvoice.customerName;
                    if (str.length > 0) {
                        label.text = str;
                    }
                    else {
                    ...
                    break;}
                case 11:{
                    NSString *str = currentInvoice.customerAddressLine1;
                    if (str.length > 0) {
                        label.text = str;
                    }
                    else {
                    ...
                    break;}
                case 12:{
                    NSString *str = currentInvoice.customerAddressLine2;
                    if (str.length > 0) {
                        label.text = str;
                    }
                    else {
                    ...
                    break;}
                case 13:{
                    NSString *str = currentInvoice.customerAddressLine3;
                    if (str.length > 0) {
                        label.text = str;
                    }
                    else {
                    ...
                    break;}
                case 14:{
                    NSString *str = currentInvoice.customerPostcode;
                    if (str.length > 0) {
                        label.text = str;
                    }
                    else {
                    ...
                    break;}
                case 15:{
                    NSString *str = currentInvoice.customerTelephone;
                    if (str.length > 0) {
                        label.text = str;
                    }
                    else {
                    ...
                    break;}
                case 16:{
                    NSString *str = currentInvoice.customerMobile;
                    if (str.length > 0) {
                        label.text = str;
                    }
                    else {
                ...
                case 23:{
                    NSString *str = currentInvoice.uniqueInvoiceNo;
                    if (str.length > 0) {
                        label.text = str;
                    }
                    else {
                ...
                case 30:{
                    NSString *str = [NSString stringWithFormat:@"%@%@", [LACHelperMethods getDefaultCurrency], currentInvoice.total];
                    if (str.length > 0) {
                        label.text = str;
                    }
                    else {
                    ...
                    break;}
                case 31:{
                    NSString *str = [NSString stringWithFormat:@"%@%@", [LACHelperMethods getDefaultCurrency], currentInvoice.paid];
                    if (str.length > 0) {
                        label.text = str;
                    }
                    else {
                ...
                case 41:{
                    NSString *str = [NSString stringWithFormat:@"%@%@", [LACHelperMethods getDefaultCurrency], cert.amount];
                    if (str.length > 0) {
                        label.text = str;
                    }
                    else {
